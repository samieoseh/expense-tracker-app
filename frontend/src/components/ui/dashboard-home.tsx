...
const DashboardHome = ({
  ...
  return (
    <main className={clsx("pt-8", className)}>
      <>
        ...
        <div className="pt-8">
              ...
              <Dialog>
                ...
                <DialogContent className="sm:max-w-[425px]">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Please enter the details of your new transaction below.
                    </DialogDescription>
                  </DialogHeader>
                  <DashboardAdd />
                </DialogContent>
          ...
          <ScrollArea className="h-72 w-full rounded-md mt-8">
            <div className="flex flex-col space-y-3">
              {transactionData.data.map((transaction, id) => {
