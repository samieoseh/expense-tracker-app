    ...
    <div className="w-[90%] mx-auto pt-4">
      ...
      <main className="pt-8">
        ...
        <div className="flex justify-between pt-8 space-x-8">
          <div className="border flex flex-1 space-x-4 bg-background rounded-lg shadow-md py-2 px-4 border-green-200">
            ...
            <div>
              <p className="text-foreground">Income</p>
              <h3 className="text-foreground">$8,000</h3>
            </div>
          </div>
          <div className="border flex flex-1 space-x-4 bg-background rounded-lg shadow-md py-2 px-4 border-red-200">
            <div className="bg-red-100 w-12 h-12 flex items-center justify-center rounded-[100%]">
              <LucideArrowDownLeft fill="red" stroke="red" />
            </div>
            <div>
              <p className="text-foreground">Expenses</p>
              <h3 className="text-foreground">-$2,000</h3>
            </div>
          </div>
        </div>
        <div className="pt-8">
